...
@Component
@StepScope
public class WeeklyRankingProcessor implements ItemProcessor<ProductMetrics, ScoredProductMetrics> {

    @Override
    public ScoredProductMetrics process(ProductMetrics productMetrics) throws Exception {
